...
export class HomePage {
  ...
  private useClientCategoryProductsService = inject(
    UseClientCategoryProductsService
  );
  ...
  readonly products = toSignal(
    this.useClientProductService.getFavoriteProducts()
  );
  readonly categoryProducts = toSignal(
    this.useClientCategoryProductsService.getCategoryProducts()
  );
